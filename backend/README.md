...
## Project Structure
    ...
    ├── testapiautoconnecto_99125  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_99125`
...
2. Clone this repo and `cd testapiautoconnecto_99125`
